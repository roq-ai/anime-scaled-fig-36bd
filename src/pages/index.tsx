...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Anime Scaled Figure Store v2`}</title>

        <meta
          name="description"
          content="Empower your passion with Anime Scaled Figure Store v2 - a comprehensive hub for collectors and store management alike. Manage profiles, wish lists, inventory, and engage in lively discussions. Unleash the power of sales analytics for smart restocking and promotions."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1519638399535-1b036603ac77?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxhbmltZXxlbnwwfHx8fDE2OTM1NjAyMzd8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Anime Scaled Figure Store v2`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Empower your passion with Anime Scaled Figure Store v2 - a comprehensive hub for collectors and store management alike. Manage profiles, wish lists, inventory, and engage in lively discussions. Unleash the power of sales analytics for smart restocking and promotions.`}
            </Text>
            <Box
