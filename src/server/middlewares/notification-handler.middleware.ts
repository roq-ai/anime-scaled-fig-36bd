...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'figure_inventory.create': {
    roles: ['store-owner', 'store-administrator'],
    key: 'new-figure-added',
    tenantPath: ['store', 'figure_inventory'],
    userPath: [],
  },
  'purchase_history.create': {
    roles: ['store-owner', 'store-administrator'],
    key: 'figure-purchased',
    tenantPath: ['store', 'user', 'purchase_history'],
    userPath: [],
  },
  'discussion_board.create': {
    roles: ['store-owner', 'store-administrator'],
    key: 'new-discussion-topic',
    tenantPath: ['store', 'user', 'discussion_board'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['store-owner', 'store-administrator', 'inventory-manager'];
